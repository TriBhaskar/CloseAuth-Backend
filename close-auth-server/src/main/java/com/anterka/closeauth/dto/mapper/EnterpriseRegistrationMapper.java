...
public interface EnterpriseRegistrationMapper {
    ...
    @Mapping(target = "city", source = "enterpriseDetails.enterpriseCity")
    ...
    @Mapping(target = "status", expression = "java(com.anterka.closeauth.constants.UserStatusEnum.UNBLOCKED)")
